...
import {
  ...
  import axios from "axios";
     ...
     const getSearchResults = async(searchTerm)=> await axios.get(`https://www.googleapis.com/books/v1/volumes?q=${searchTerm}+terms`);
...
//         axios
//           .get(
//             `https://www.googleapis.com/books/v1/volumes?q=${action.payload.name}+terms`
//           )
//           .then((resp) => {
//             getData( resp.data.items )
//           })
//       );
